...
namespace ManagedDoom
{
    public sealed class GameContent : IDisposable
    {
        ...
        /// <summary>
        /// Load game content from an in-memory WAD stream (no filesystem access for the WAD).
        /// wadName should match the WAD type: "doom1", "doom2", "doom", etc.
        /// </summary>
        public GameContent(Stream wadStream, string wadName, CommandLineArgs args)
        {
            wad = new Wad(wadStream, wadName);
